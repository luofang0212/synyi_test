...
for i in range(1, 2):
    ...
    # 指定日期 转换
    data = random.randint(31, 31)
    get_time = '2021-08-{0} 18:25:01.000000'.format(data)
    now_time = datetime.strptime(get_time, '%Y-%m-%d %H:%M:%S.%f')
    real_time = now_time

    get_time_2 = '2021-08-{0} 17:40:01.000000'.format(data)
    now_time_2 = datetime.strptime(get_time_2, '%Y-%m-%d %H:%M:%S.%f')

    get_time_3 = '2021-08-{0} 18:40:01.000000'.format(data)
    ...
    compare_time = '2021-08-{0} 12:00:00.000000'.format(data)
