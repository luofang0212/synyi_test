...
mysql_bi = PlSqlDbBI()
sql_1 = '''select max(fee_detail_id) from data.pg_fee_detail;'''
...
for i in range(1, 1209):
    ...
    # 指定日期 转换
    data_month = random.randint(1,10)
    get_time = '2021-{0}-10 00:00:00.000000'.format(data_month)
    ...
    sql_3 = '''
    insert into data.pg_fee_detail (fee_detail_id, org_code, source_app, source_fee_detail_id, source_visit_id,
