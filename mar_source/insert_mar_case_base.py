...
for i in range(1,274):
    ...
    in_total_cost = random.randint(10000,300000)
    ...
    sql_3 = '''insert into source.case_base (case_id, org_code, source_app, source_case_id, source_visit_id, source_patient_id,
                              ...
                              low_risk_group_flag, charge_consumption_standard, time_consumption_standard,org_name)
values ({0}, '{9}', '{1}', 1935806002, 1935806002, 60296403, '张凤兰', 140598, '全自费', 2, null, '女性',
        ...
        '靖江市靖江江阴开发区八圩村前义太庄5号', 13852621654, '{2}', '{2}', {3}, '{4}',
        ...
        0, null, null, null, 0, 0, 0, 0, 0, 1, '{6}', 0, null, null, 0, null, {15}, 660.0000, 221.7000,
        ...
        null, null, null, null, null, null, null, null, null, null, null, {7}, {7}, '{8}', '{2}',
        552, '{14}', '{13}', 2, 2, 140610, 1, null, 0, 96218, '{11}', '{12}', 0, '择期', 2, '病区医生|0210', '泌尿外科', 828581, 18,
        '泌尿外科', {3}, '{4}', null, null, null, null, null, null, null, null, null, null, {5}, null, null, null, null,
        null, null, null, null, null, null,'{10}');
        '''.format(max_case_id, source_app, update_time, dept_id, dept_name, dept_id, dept_name, doc_id, doc_name,
                   org_code, org_name, age_group_code, age_group_name,visit_type_code,visit_type,in_total_cost)
